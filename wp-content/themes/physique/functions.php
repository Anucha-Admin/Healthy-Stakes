...
function physique_font_url(){
		...
		*/
		$oswald = _x('on', 'Oswald font:on or off','physique');
		
		/* Translators: If there are any character that are
		* not supported by Assistant, translate this to off, do not
		* translate into your own language.
		*/
		$ass = _x('on', 'Assistant font:on or off','physique');
		
		/* Translators: If there are any character that are
		* not supported by Roboto, translate this to off, do not
		* translate into your own language.
		*/
		$roboto = _x('on', 'Roboto font:on or off','physique');
		
		
		
		if('off' !== $oswald || 'off' !== $ass || 'off' !== $roboto){
			$font_family = array();
